...
const CompanyForm = () => {
  ...
  return (
    <div className="flex flex-col w-64 p-2 gap-2">
      ...
      <TextField variant="standard" placeholder="Nome Completo" name="name" value={company.name} onChange={handledChange}/>
      
      <TextField variant="standard" placeholder="CNPJ" name="cnpj" value={company.cnpj} onChange={handledChange}/>
      
      <TextField variant="standard" placeholder="Telefone" name="phone" value={company.phone} onChange={handledChange}/>
      
      <TextField variant="standard" placeholder="Domínio" name="email" value={company.email} onChange={handledChange}/>
      
      <TextField variant="standard" placeholder="Senha" type="password" name="password" value={company.password} onChange={handledChange}/>
