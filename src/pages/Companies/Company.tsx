...
const Company = () => {
  ...
  const handleCepChange = async () => {
    if (addressForm.zip_code.length < 8) return;
  ...
  const allFieldsFilled = useMemo(() => {
    switch (activeStep) {
      case 0:
        return !companyForm.cnpj || !companyForm.name || !companyForm.phone;
      case 1:
        return (
          !addressForm.city ||
          !addressForm.country ||
    ...
    <Box>
      <HeaderWrapper>
        ...
        <ButtonStyled
          ...
          <Typography fontSize={fontSizeConfig.medium}>Adicionar</Typography>
        </ButtonStyled>
